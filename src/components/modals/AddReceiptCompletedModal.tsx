...
import { View, Text, StyleSheet, TouchableOpacity, Modal, TouchableWithoutFeedback, Image, ImageBackground } from 'react-native';
            ...
            <View style={modalStyles.messageContainer}>
                <View style={modalStyles.ticImage}>
                    <ImageBackground
                        ...
                        resizeMode='contain'
                    >
                        <Icon style={modalStyles.ticIcon} name="check" size={25} color="#fff" />
                    </ImageBackground>
                </View>
                <View>
                ...
                <View>
                    <Text style={modalStyles.subTitle}>Wir haben Ihren Beleg erhalten und beginnen umgehend mit der Prüfung.</Text>
                </View>
            </View>
            <NextButton 
