...
const DataProtectionModalContent = ({ data }) => (
  ...
  <ScrollView style={styles.modalWrapper}>
    ...
    <Text style={styles.paragraph}>oder über das Kontaktformular.</Text>
    ...
    <Text style={styles.paragraph}>
      ...
      <Text style={styles.link} onPress={() => Linking.openURL('https://www.lifebalanceplus.de/datenschutz/')}>
...
const ImprintModalContent = ({ data }) => (
  ...
  <ScrollView style={styles.modalWrapper}>
    ...
    <Text style={styles.paragraph}>
      Ihre Privatsphäre ist uns wichtig. lifebalance:plus GmbHs espektiert Ihre Privatsphäre und hält sich an alle geltenden Gesetze und Vorschriften in Bezug auf persönliche Daten, die wir über Sie sammeln, auch über unsere App lifebalance:plus und die damit verbundenen Dienste.
    </Text>
    <Text style={styles.paragraph}>
      Personenbezogene Daten sind alle Informationen über Sie, die dazu verwendet werden können, Sie zu identifizieren. Dazu gehören Informationen über Sie als Person (z. B. Name, Adresse und Geburtsdatum), Ihre Geräte, Zahlungsdetails und sogar Informationen darüber, wie Sie eine App oder einen Online-Dienst nutzen.
    </Text>
    <Text style={styles.paragraph}>
      Beachten Sie bitte, dass Links zu Seiten und Dienstleistungen bedeuten, dass diese Seiten ihre eigenen Datenschutzrichtlinien haben. Nachdem Sie auf eine solche Seite gelangen, sollten Sie sich mit den dortigen Datenschutzrichtlinien vertraut machen, um zu verstehen, wie Ihre persönlichen Daten verwendet werden. Diese Datenschutzrichtlinie gilt ausdrücklich nicht für jedwede Aktivitäten, nachdem Sie unsere Webseite verlassen.
    </Text>
    <Text style={styles.paragraph}>
    ...
    <Text style={styles.paragraph}>
      Wenn Sie über unsere App auf unsere Server zugreifen, protokollieren wir möglicherweise automatisch die von Ihrem Gerät bereitgestellten Standarddaten. Dazu gehören die Internetprotokoll-Adresse (IP) Ihres Geräts, der Typ und die Version Ihres Geräts, Ihre Aktivitäten innerhalb der App, die Uhrzeit und das Datum sowie weitere Details über Ihre Nutzung.
    </Text>
    <Text style={styles.paragraph}>
      Weiterhin gilt: Wenn Sie bei der Nutzung der App auf bestimmte Fehler stoßen, erfassen wir außerdem automatisch Daten über den Fehler und die Umstände seines Auftretens. Diese Daten können technische Details über Ihr Gerät enthalten, was Sie versuchten zu tun, als der Fehler auftrat, und andere technische Informationen in Bezug auf das Problem. Es kann sein, dass Sie von solchen Fehlern, selbst wenn sie auftreten, keine Nachricht erhalten, dass sie aufgetreten sind oder welcher Art der Fehler ist.
    </Text>
    <Text style={styles.paragraph}>
    ...
    <Text style={styles.paragraph}>
      Wenn Sie die App installieren oder die Tools Ihres Geräts innerhalb der App verwenden, bitten wir Sie um die Erlaubnis, auf diese Informationen zuzugreifen. Die spezifischen Daten, die wir sammeln, können von den individuellen Einstellungen Ihres Geräts und den Berechtigungen abhängen, die Sie bei der Installation und Nutzung der App erteilen.
    </Text>
    <Text style={styles.h3}>Persönliche Daten</Text>
    <Text style={styles.paragraph}>
      Wir können nach persönlichen Daten fragen — wenn Sie uns kontaktieren — die eine oder mehrere der folgenden Informationen enthalten können:
    </Text>
    <View style={styles.listContainer}>
      <Text style={styles.listItem}>• Rechnungen</Text>
      <Text style={styles.listItem}>• Belege</Text>
    </View>
    <Text style={styles.h3}>Berechtigte Gründe für die Verarbeitung personenbezogener Daten</Text>
    <Text style={styles.paragraph}>
    ...
    <Text style={styles.paragraph}>
      Wir können personenbezogene Daten von Ihnen erfassen, wenn Sie eine der folgenden Aktionen in unserer App durchführen:
    </Text>
    <View style={styles.listContainer}>
      <Text style={styles.listItem}>• Mit Mobilgerät oder Web-Browser auf unseren Content zugreifen</Text>
      <Text style={styles.listItem}>• Kontaktieren Sie uns per E-Mail, über Social Media oder ähnliche Technologien</Text>
      <Text style={styles.listItem}>• Wenn Sie uns auf Social Media erwähnen</Text>
    </View>
    <Text style={styles.paragraph}>
      Wir können freiwillig bereitgestellte und automatisch erfasste personenbezogene Informationen mit allgemeinen Informationen oder Forschungsdaten kombinieren, die wir von anderen vertrauenswürdigen Quellen erhalten. Wenn Sie uns beispielsweise den Zugriff auf Ihre Social-Media-Profile gestatten, können wir Informationen, die von diesen Profilen stammen, mit Informationen, die Sie uns direkt gegeben haben, kombinieren, um Ihnen eine verbesserte Nutzungserfahrung unserer App und Dienste zu bieten.
    </Text>
    ...
    <Text style={styles.h4}>Wie lange wir Ihre persönlichen Daten behalten</Text>
    <Text style={styles.paragraph}>
    ...
    <Text style={styles.h3}>Ihre Rechte und die Kontrolle Ihrer persönlichen Daten</Text>
    <Text style={styles.paragraph}>
      <Text style={styles.bold}>Ihre Wahl:</Text> Indem Sie uns personenbezogene Daten zur Verfügung stellen, verstehen Sie, dass wir Ihre personenbezogenen Daten in Übereinstimmung mit dieser Datenschutzrichtlinie sammeln, speichern, verwenden und offenlegen. Sie müssen uns keine personenbezogenen Daten zur Verfügung stellen, jedoch kann es Ihre Nutzung unserer App oder der über sie angebotenen Produkte und/oder Dienstleistungen beeinträchtigen, wenn Sie dies nicht tun.
    </Text>
    <Text style={styles.paragraph}>
      <Text style={styles.bold}>Daten von Drittanbietern:</Text> Wenn wir persönliche Informationen über Sie von einem Dritten erhalten, werden wir diese wie in dieser Datenschutzerklärung beschrieben schützen. Wenn Sie ein Drittanbieter sind, der persönliche Daten einer anderen Person zur Verfügung stellt, sichern Sie zu, dass Sie die Zustimmung dieser Person haben, diese an uns weiterzugeben.
    </Text>
    <Text style={styles.paragraph}>
      <Text style={styles.bold}>Marketing-Erlaubnis:</Text> Wenn Sie zuvor zugestimmt haben, dass wir Ihre persönlichen Daten für Direktmarketing verwenden, können Sie Ihre Meinung jederzeit ändern, indem Sie sich mit uns in Verbindung setzen und die nachstehenden Angaben machen
    </Text>
    <Text style={styles.paragraph}>
      <Text style={styles.bold}>Zugriff:</Text> Sie können Einzelheiten zu den persönlichen Daten anfordern, die wir über Sie gespeichert haben.
    </Text>
    <Text style={styles.paragraph}>
      <Text style={styles.bold}>Korrektur:</Text> Wenn Sie der Meinung sind, dass Informationen, die wir über Sie gespeichert haben, ungenau, veraltet, unvollständig, irrelevant oder irreführend sind, wenden Sie sich bitte an uns unter Verwendung der in dieser Datenschutzrichtlinie angegebenen Kontaktmöglichkeiten. Wir werden angemessene Schritte unternehmen, um alle Informationen zu korrigieren, die sich als ungenau, unvollständig, irreführend oder veraltet erweisen.
    </Text>
    <Text style={styles.paragraph}>
      <Text style={styles.bold}>Nicht-Diskriminierung:</Text> Wir werden Sie nicht benachteiligen, wenn Sie eines Ihrer Rechte in Bezug auf Ihre persönlichen Daten wahrnehmen. Sofern Ihre persönlichen Daten nicht benötigt werden, um Ihnen eine bestimmte Dienstleistung oder ein bestimmtes Angebot zu unterbreiten (beispielsweise Benutzerunterstützung), werden wir Ihnen keine Waren oder Dienstleistungen vorenthalten und/oder Ihnen andere Preise oder Tarife für Waren oder Dienstleistungen in Rechnung stellen, auch nicht durch die Gewährung von Rabatten oder anderen Vorteilen oder die Verhängung von Strafen, oder Ihnen ein anderes Niveau oder eine andere Qualität von Waren oder Dienstleistungen bieten.
    </Text>
    <Text style={styles.paragraph}>
      <Text style={styles.bold}>Benachrichtigung über Datenschutzverletzungen:</Text> Wir werden die auf uns anwendbaren Gesetze in Bezug auf jede Datenschutzverletzung einhalten.
    </Text>
    <Text style={styles.paragraph}>
      <Text style={styles.bold}>Beschwerde:</Text> Wenn Sie der Meinung sind, dass wir gegen ein entsprechendes Datenschutzgesetz verstoßen haben, und eine Beschwerde einreichen möchten, wenden Sie sich bitte unter Verwendung der nachstehenden Angaben an uns und teilen Sie uns alle Einzelheiten zu dem mutmaßlichen Verstoß mit. Wir werden Ihre Beschwerde umgehend untersuchen und Ihnen schriftlich antworten, wobei wir Ihnen das Ergebnis unserer Untersuchung und die Schritte mitteilen werden, die wir unternehmen werden, um Ihre Beschwerde zu bearbeiten. Sie haben auch das Recht, sich mit Ihrer Beschwerde an Ihren Datenschutzbeauftragten oder eine Regulierungsbehörde zu wenden.
    </Text>
    <Text style={styles.paragraph}>
      <Text style={styles.bold}>Abmelden:</Text> Um sich von unserer E-Mail-Datenbank abzumelden oder Mitteilungen (einschließlich Marketingmitteilungen) abzubestellen, wenden Sie sich bitte an uns, indem Sie die in dieser Datenschutzrichtlinie angegebenen Kontaktmöglichkeiten verwenden, oder nutzen Sie die in der Mitteilung angegebenen Abmeldemöglichkeiten. Gegebenenfalls müssen wir Sie um bestimmte Informationen bitten, damit wir Ihre Identität bestätigen können.
    </Text>
    <Text style={styles.h3}>Verwendung von Cookies</Text>
    <Text style={styles.paragraph}>
      Unsere Datenschutzrichtlinie behandelt die Verwendung von Cookies zwischen Ihrem Gerät und unseren Servern. Ein Cookie ist eine kleine Datei, die eine App auf Ihrem Gerät speichern kann. Sie enthält in der Regel eine eindeutige Kennung, die es den App-Servern ermöglicht, Ihr Gerät zu erkennen, wenn Sie die App verwenden, Informationen über Ihren Account, Ihre Sitzung und/oder Ihr Gerät, zusätzliche Daten, die dem Zweck des Cookies dienen, sowie Informationen über die Selbstwartung des Cookies.
    </Text>
    <Text style={styles.paragraph}>
      Wir verwenden Cookies, um Ihrem Gerät den Zugang zu den Hauptfunktionen unserer App zu ermöglichen, die Nutzung der App und die Leistung auf Ihrem Gerät zu verfolgen, die Nutzung unserer App auf Ihre Präferenzen zuzuschneiden und Werbung auf Ihrem Gerät anzuzeigen. Jegliche Kommunikation von Cookie-Daten zwischen Ihrem Gerät und unseren Servern erfolgt in einer sicheren Umgebung.
    </Text>
    <Text style={styles.paragraph}>
    ...
    <Text style={styles.h3}>Zusätzliche Angaben zur Einhaltung der Allgemeinen Datenschutzgrundverordnung (DSGVO) (EU)</Text>
    <Text style={styles.h4}>Datenverantwortlicher / Datenverarbeiter</Text>
    <Text style={styles.paragraph}>
      Die DSGVO unterscheidet zwischen Organisationen, die personenbezogene Daten für ihre eigenen Zwecke verarbeiten (bekannt als "Datenverantwortliche") und Organisationen, die personenbezogene Daten im Auftrag anderer Organisationen verarbeiten (bekannt als "Datenverarbeiter"). Wir, lifebalance:plus GmbH, mit Sitz an der in unserem Abschnitt "Kontakt" angegebenen Adresse, sind ein Datenverarbeiter in Bezug auf die personenbezogenen Daten, die Sie uns zur Verfügung stellen
    </Text>
    <Text style={styles.h4}>Rechtsgrundlagen für die Verarbeitung Ihrer persönlichen Daten</Text>
    <Text style={styles.paragraph}>
    ...
    <Text style={styles.paragraph}>
      Wenn Sie uns Ihr Einverständnis geben, Ihre personenbezogenen Daten für einen bestimmten Zweck zu erfassen und zu verwenden. Sie können Ihre Zustimmung jederzeit über die von uns bereitgestellten Möglichkeiten widerrufen; dies hat jedoch keine Auswirkungen auf eine bereits erfolgte Verwendung Ihrer Daten. Wenn Sie mit uns Kontakt aufnehmen, können Sie der Verwendung Ihres Namens und Ihrer E-Mail-Adresse zustimmen, damit wir Ihre Anfrage beantworten können. Sie können zwar jederzeit verlangen, dass wir Ihre Kontaktdaten löschen, aber wir können keine bereits gesendeten E-Mails zurückrufen. Wenn Sie weitere Fragen dazu haben, wie Sie Ihre Zustimmung zurückziehen können, wenden Sie sich bitte an die im Abschnitt "Kontakt" dieser Datenschutzrichtlinie angegebenen Daten.
    </Text>
    <Text style={styles.h3}>Erfüllung eines Vertrags oder einer Transaktion</Text>
    <Text style={styles.paragraph}>
      Wenn Sie einen Vertrag oder eine Transaktion mit uns abgeschlossen haben, oder um vorbereitende Schritte zu unternehmen, bevor wir einen Vertrag oder eine Transaktion mit Ihnen abschließen. Zum Beispiel, Wir benötigen technische Informationen über Ihr Gerät, um die wesentlichen Funktionen unserer App bereitstellen zu können.
    </Text>
    <Text style={styles.h3}>Unsere berechtigten Interessen</Text>
    <Text style={styles.paragraph}>
      Wenn wir der Meinung sind, dass dies für unsere berechtigten Interessen notwendig ist, z. B. um unsere Dienste bereitzustellen, zu betreiben, zu verbessern und zu kommunizieren. Wir sammeln zum Beispiel technische Daten über Ihr Gerät, um Ihre Erfahrung mit unserer App zu verbessern und zu personalisieren. Zu unseren berechtigten Interessen gehören Forschung und Entwicklung, das Verständnis unserer Zielgruppe, Marketing und Werbung für unsere Dienste, Maßnahmen zum effizienten Betrieb unserer Dienste, Marketinganalysen und Maßnahmen zum Schutz unserer gesetzlichen Rechte und Interessen.
    </Text>
    ...
    <Text style={styles.h4}>Internationale Übermittlungen außerhalb des Europäischen Wirtschaftsraums (EWR)</Text>
    <Text style={styles.paragraph}>
    ...
    <Text style={styles.h4}>Ihre Rechte und die Kontrolle über Ihre personenbezogenen Daten</Text>
    <Text style={styles.paragraph}>
      <Text style={styles.bold}>Einschränken:</Text> Sie haben das Recht, uns aufzufordern, die Verarbeitung Ihrer personenbezogenen Daten einzuschränken, wenn (i) Sie Bedenken hinsichtlich der Richtigkeit Ihrer personenbezogenen Daten haben; (ii) Sie der Meinung sind, dass Ihre personenbezogenen Daten unrechtmäßig verarbeitet wurden; (iii) Sie die personenbezogenen Daten ausschließlich für die Zwecke eines Rechtsanspruchs benötigen, oder (iv) wir gerade Ihren Einspruch gegen die Verarbeitung auf der Grundlage legitimer Interessen prüfen.
    </Text>
    <Text style={styles.paragraph}>
      <Text style={styles.bold}>Einspruch gegen die Verarbeitung:</Text> Sie haben das Recht, der Verarbeitung Ihrer personenbezogenen Daten zu widersprechen, wenn dies auf unserem berechtigten oder öffentlichem Interesse beruht. In diesem Fall müssen wir zwingende legitime Gründe für die Verarbeitung vorbringen, die Ihre Interessen, Rechte und Freiheiten überwiegen, damit wir mit der Verarbeitung Ihrer personenbezogenen Daten fortfahren können.
    </Text>
    <Text style={styles.paragraph}>
      <Text style={styles.bold}>Datenübertragbarkeit:</Text> Sie haben das Recht, eine Kopie der personenbezogenen Daten anzufordern, die wir über Sie gespeichert haben. Wenn möglich, stellen wir Ihnen diese Informationen im CSV-Format oder einem anderen leicht lesbaren maschinellen Format zur Verfügung. Sie haben auch das Recht zu verlangen, dass wir diese personenbezogenen Daten an einen Dritten weitergeben.
    </Text>
    <Text style={styles.paragraph}>
      <Text style={styles.bold}>Löschung:</Text> Sie haben das Recht, jederzeit die Löschung der personenbezogenen Daten zu verlangen, die wir über Sie gespeichert haben, und wir werden angemessene Schritte unternehmen, um Ihre personenbezogenen Daten aus unseren derzeitigen Unterlagen zu löschen. Wenn Sie uns bitten, Ihre personenbezogenen Daten zu löschen, werden wir Sie darüber informieren, wie sich die Löschung auf Ihre Nutzung unserer App, Webseite oder unserer Produkte und Dienstleistungen auswirkt. Von diesem Recht kann es aus bestimmten rechtlichen Gründen Ausnahmen geben, die wir Ihnen gegebenenfalls in unserer Antwort auf Ihre Anfrage mitteilen werden. Wenn Sie Ihren Account kündigen oder löschen, werden wir Ihre persönlichen Daten innerhalb von 30 Tagen nach der Löschung Ihres Accounts löschen. Bitte beachten Sie, dass Suchmaschinen und ähnliche Dienste Kopien Ihrer personenbezogenen Daten, die zumindest einmal veröffentlicht wurden, wie beispielsweise bestimmte Profilinformationen und öffentliche Kommentare, diese auch dann noch aufbewahren können, wenn Sie diese Informationen aus unseren Diensten gelöscht oder Ihr Konto deaktiviert haben.
    </Text>
    ...
    <Text style={styles.paragraph}>
      Uwe Meyer{'\n'}
      <Text style={styles.link} onPress={() => Linking.openURL('https://www.lifebalanceplus.de/kontakt/')}>
...
const OtherInformation = () => {
  ...
  return (
    <>
      ...
      <DataProtectionModal visible={showDataProtection} onClose={handleCloseDataProtection}>
